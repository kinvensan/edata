package com.github.edata.sql.meta;

import com.github.edata.sql.annotation.TemplateFunction;
import com.github.edata.sql.annotation.TemplateFunctionConfig;
...
public class FunctionInfo {
    ...
    public void register(Class<?> clazz){
        if(clazz.isAnnotationPresent(TemplateFunction.class)){
