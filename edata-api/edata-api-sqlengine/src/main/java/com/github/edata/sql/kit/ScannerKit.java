package com.github.edata.sql.kit;
...
public class ScannerKit {
    ...
    public static void scanFunction(String basePack){
        getClasses(basePack).stream().forEach(clazz -> {
    ...
    public static void scanEntityTable(String basePack){
        getClasses(basePack).stream().forEach(clazz -> {
    ...
    public static Map<String,FunctionInfo> getFunctionInfoMap(){
    ...
    public static EntityTableInfo getEntityTableInfo(String name){
